...
export function ExperienceTabs() {
	const projectsWithImages = [
		...
		{
			title: "AI Pro",
			description: "A suite of different AI Tools such as a chatbot, pdf reader, travel assistant, and many more.",
		...
		{
			title: "Chat-Me",
			description: "A solo side project. Aims to be a cross-platform chat application that uses end-to-end encryption.",
			role: "Fullstack Developer",
